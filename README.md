...
Open-source and vector-free, KITE achieves **🥇 93.51% on LoCoMo and 🥇 85.60% on LongMemEval-S**, with *gpt-4.1-mini* used across all benchmark stages and an average reader context of only **~1.6K tokens per question**.
